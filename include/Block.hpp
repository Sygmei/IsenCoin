...
namespace ic
{
    ...
    private:
        ...
        static bool is_nonce_valid(block_hash_t& block_hash, uint64_t nonce, timestamp_t timestamp);
    ...
    public:
        ...
        void validate();
        static signature_t get_hash(block_hash_t& block_hash, uint64_t nonce, timestamp_t timestamp);
